...
extern const u16 gFontTinyLatinGlyphs[];
extern const u8 gFontTinyLatinGlyphWidths[];
extern const u16 gFontTinyNarrowLatinGlyphs[];
extern const u8 gFontTinyNarrowLatinGlyphWidths[];
