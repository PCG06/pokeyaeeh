...
#define FLAG_MOVE_RELEARNER 0x2BB // Used to distinguish between the actual move relearner and the Moves option in the party menu.
...
#define FLAG_NO_BAG_USE                                             0x4EF // Unused Flag
