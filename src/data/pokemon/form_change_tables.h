...
static const struct FormChange sUrshifuSingleStrikeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA,   ITEM_URSHIFUNITE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sUrshifuRapidStrikeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_URSHIFU_RAPID_STRIKE_STYLE_MEGA,    ITEM_URSHIFUNITE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sTinkatonFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TINKATON_MEGA,    ITEM_TINKATITE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sLuxrayFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_LUXRAY_MEGA,    ITEM_LUXRAYNITE},
    {FORM_CHANGE_TERMINATOR},
};
