...
{
    [MUGSHOT_SIDNEY]   = sMugshotPal_Sidney, // purple
    [MUGSHOT_PHOEBE]   = sMugshotPal_Phoebe, // green
    [MUGSHOT_GLACIA]   = sMugshotPal_Glacia, // pink
    [MUGSHOT_DRAKE]    = sMugshotPal_Drake, // blue
    [MUGSHOT_CHAMPION] = sMugshotPal_Champion, // yellow
    [MUGSHOT_BRENDAN]  = sMugshotPal_Drake,
    [MUGSHOT_MAY]      = sMugshotPal_Glacia,
    [MUGSHOT_WALLY]    = sMugshotPal_Phoebe,
    [MUGSHOT_STEVEN]   = sMugshotPal_Sidney,
};
