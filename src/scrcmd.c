...
const u16 sTMsToGive[NUM_BADGES][15] = {
    ...
    // Gym 4
    {
        ITEM_TM_RETURN, ITEM_TM_FRUSTRATION, ITEM_TM_STOMPING_TANTRUM, ITEM_TM_TEMPER_FLARE, ITEM_TM_TAUNT,
    ...
    // Gym 6
    {
        ITEM_TM_POLLEN_PUFF, ITEM_TM_SPIKES, ITEM_TM_TOXIC_SPIKES, ITEM_TM_AGILITY, ITEM_TM_BATON_PASS,
        ITEM_TM_SUBSTITUTE, ITEM_TM_AMNESIA, ITEM_TM_IRON_DEFENSE, ITEM_TM_CHARM, ITEM_TM_EERIE_IMPULSE,
        ITEM_TM_FOCUS_PUNCH, ITEM_TM_DEFOG, ITEM_TM_GYRO_BALL, ITEM_TM_HEAT_CRASH, ITEM_TM_FLASH_CANNON
    },
    // Gym 7
    {
        ITEM_TM_HEAVY_SLAM, ITEM_TM_MYSTICAL_FIRE, ITEM_TM_PHANTOM_FORCE, ITEM_TM_STEALTH_ROCK, ITEM_TM_SUPERCELL_SLAM,
    ...
    // Gym 8
    {
        ITEM_TM_DRAGON_PULSE, ITEM_TM_JETSTREAM, ITEM_TM_GIGA_IMPACT, ITEM_TM_HYPER_BEAM, ITEM_TM_BULK_UP,
        ITEM_TM_CALM_MIND, ITEM_TM_SCALD, ITEM_TM_SCALE_SHOT, ITEM_TM_TRIPLE_AXEL, ITEM_TM_BODY_PRESS,
