...
const u16 sTMsToGive[NUM_BADGES][15] = {
    // Gym 1
    {
        ITEM_TM_TORMENT, ITEM_TM_IMPRISON, ITEM_TM_MUD_SHOT, ITEM_TM_DEFOG, ITEM_TM_REST,
    ...
    // Gym 6
    {
        ...
        ITEM_TM_FOCUS_PUNCH, ITEM_TM_DRAGON_TAIL, ITEM_TM_JETSTREAM, ITEM_TM_HEAT_CRASH, ITEM_TM_FLASH_CANNON
    },
    // Gym 7
    {
