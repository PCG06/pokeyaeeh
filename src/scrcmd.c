...
const u16 sTMsToGive[NUM_BADGES][15] = {
    // Gym 1
    {
        ITEM_TM_TORMENT, ITEM_TM_IMPRISON, ITEM_TM_MUD_SHOT, ITEM_TM_DRAGON_TAIL, ITEM_TM_REST,
        ITEM_TM_SMACK_DOWN, ITEM_TM_THIEF, ITEM_TM_AERIAL_ACE, ITEM_TM_SLEEP_TALK, ITEM_TM_FALSE_SWIPE,
        ITEM_TM_MAGICAL_LEAF, ITEM_TM_TRI_ATTACK, ITEM_TM_ICICLE_SPEAR, ITEM_TM_BULLET_SEED, ITEM_TM_DRAINING_KISS
    },
    // Gym 2
    {
        ITEM_TM_PLUCK, ITEM_TM_DIG, ITEM_TM_STEEL_WING, ITEM_TM_TRICK, ITEM_TM_ICE_FANG,
        ITEM_TM_FIRE_FANG, ITEM_TM_THUNDER_FANG, ITEM_TM_ATTRACT, ITEM_TM_SKILL_SWAP, ITEM_TM_UPROAR,
        ITEM_TM_SNARL, ITEM_TM_SILVER_WIND, ITEM_TM_ANCIENT_POWER, ITEM_TM_OMINOUS_WIND, ITEM_TM_SEED_BOMB
    },
    // Gym 3
    {
        ITEM_TM_THUNDER_PUNCH, ITEM_TM_ICE_PUNCH, ITEM_TM_FIRE_PUNCH, ITEM_TM_AQUA_FANGS, ITEM_TM_AIR_SLASH,
        ITEM_TM_SHADOW_CLAW, ITEM_TM_X_SCISSOR, ITEM_TM_ICY_WIND, ITEM_TM_ELECTROWEB, ITEM_TM_ZEN_HEADBUTT,
        ITEM_TM_GRASS_KNOT, ITEM_TM_CROSS_POISON, ITEM_TM_ALLURING_VOICE, ITEM_TM_BRICK_BREAK, ITEM_TM_HEAT_WAVE
    },
    // Gym 4
    {
        ITEM_TM_SLUDGE_BOMB, ITEM_TM_CHARGE_BEAM, ITEM_TM_STOMPING_TANTRUM, ITEM_TM_TEMPER_FLARE, ITEM_TM_TAUNT,
        ITEM_TM_SHADOW_BALL, ITEM_TM_TOXIC, ITEM_TM_WILL_O_WISP, ITEM_TM_FROST_GLARE, ITEM_TM_THUNDER_WAVE,
        ITEM_TM_CRUNCH, ITEM_TM_HEX, ITEM_TM_DRILL_RUN, ITEM_TM_DRAGON_CLAW, ITEM_TM_GIGA_IMPACT
    },
    // Gym 5
    {
        ITEM_TM_FLAMETHROWER, ITEM_TM_THUNDERBOLT, ITEM_TM_ICE_BEAM, ITEM_TM_DARK_PULSE, ITEM_TM_ROCK_SLIDE,
        ITEM_TM_BUG_BUZZ, ITEM_TM_IRON_HEAD, ITEM_TM_THROAT_CHOP, ITEM_TM_AQUA_TAIL, ITEM_TM_POISON_JAB,
        ITEM_TM_DUAL_WINGBEAT, ITEM_TM_HYPER_VOICE, ITEM_TM_PLAY_ROUGH, ITEM_TM_PSYSHOCK, ITEM_TM_DRAIN_PUNCH
    },
    // Gym 6
    {
        ITEM_TM_POLLEN_PUFF, ITEM_TM_SPIKES, ITEM_TM_TOXIC_SPIKES, ITEM_TM_TRIPLE_AXEL, ITEM_TM_BATON_PASS,
        ITEM_TM_POWER_WHIP, ITEM_TM_AMNESIA, ITEM_TM_IRON_DEFENSE, ITEM_TM_CHARM, ITEM_TM_EERIE_IMPULSE,
        ITEM_TM_FOCUS_PUNCH, ITEM_TM_DEFOG, ITEM_TM_JETSTREAM, ITEM_TM_HEAT_CRASH, ITEM_TM_FLASH_CANNON
    },
    // Gym 7
    {
        ITEM_TM_HEAVY_SLAM, ITEM_TM_MYSTICAL_FIRE, ITEM_TM_GIGA_DRAIN, ITEM_TM_STEALTH_ROCK, ITEM_TM_SUPERCELL_SLAM,
        ITEM_TM_REVERSAL, ITEM_TM_HIGH_HORSEPOWER, ITEM_TM_LEECH_LIFE, ITEM_TM_TAILWIND, ITEM_TM_LIQUIDATION,
        ITEM_TM_PSYCHIC_FANGS, ITEM_TM_IRON_TAIL, ITEM_TM_MOONBLAST, ITEM_TM_POWER_GEM, ITEM_TM_VENOSHOCK
    },
    // Gym 8
    {
        ITEM_TM_DRAGON_PULSE, ITEM_TM_GYRO_BALL, ITEM_TM_ROOST, ITEM_TM_PHANTOM_FORCE, ITEM_TM_BULK_UP,
        ITEM_TM_CALM_MIND, ITEM_TM_SCALD, ITEM_TM_SCALE_SHOT, ITEM_TM_FLIP_TURN, ITEM_TM_BODY_PRESS,
        ITEM_TM_HARD_PRESS, ITEM_TM_EARTH_POWER, ITEM_TM_U_TURN, ITEM_TM_VOLT_SWITCH, ITEM_TM_KNOCK_OFF
    }
};

void GivePlayerTMs(void)
{
    u16 flagVal = VarGet(VAR_0x8000);
    u16 i;

    for (i = 0; i < 15; i++)
        AddBagItem(sTMsToGive[flagVal][i], 1);
